        ...
        return (
            <div className="min-h-60">
                ...
                <div className="flex justify-evenly w-full">
                    ...
                    <div className="p-4 text-center bg-indigo-900 w-1/2 font-semibold hover:bg-rose-700 text-indigo-50 transition-all cursor-pointer">Decline</div>
                </div>
            </div>
        )
    }
...
const RequestCard = (props) => {
    ...
    return (
        <div className="flex items-center rounded-2xl m-3 shadow-lg bg-indigo-800 overflow-hidden max-h-36" id={props.id}
            ...
            <div className="flex-1 flex-col flex gap-3 w-1/2 justify-center h-full hover:bg-indigo-900 transition-colors p-4 cursor-pointer">
