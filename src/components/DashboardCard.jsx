...
const DashboardSection = (props) => {
    return (
        <div className=" w-full bg-indigo-100 mx-auto rounded-2xl flex flex-col gap-3 overflow-hidden mt-2">
            ...
            <Card Components={<SentRequests sentRequests={props.sentRequests} />} />
        </div>
    )
}
...
const SentRequests = (props) => {
    console.log(props.sentRequests)
        return (
            <div className="w-full">
                <div className="p-4 flex justify-center">
                    <h1 className="text-indigo-50 font-semibold text-xl">
...
const RequestCard = (props) => {
    return (
        <div>
        <div className="flex flex-row items-center bg-indigo-800 rounded-2xl m-2 py-4 w-[95%]">
