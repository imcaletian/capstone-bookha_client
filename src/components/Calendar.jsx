                ...
                <>
                    <div className="flex items-center justify-center">
                        <div className="w-full shadow-lg">
                            <div className="md:p-16 md:pb-12 p-5 dark:bg-indigo-900 bg-white">
                                <div className="px-4 flex items-center justify-between">
                                    <h1 className="text-xl font-bold dark:text-gray-100 text-gray-800">October 2020</h1>
                                            ...
                                            <tr>
                                                <th>
                                                    <div className="w-full flex justify-center">
                                                        <p className="text-2xl font-medium text-center text-gray-800 dark:text-gray-100">M</p>
                                                    </div>
                                                </th>
                                                <th>
                                                    <div className="w-full flex justify-center">
                                                        <p className="text-2xl font-medium text-center text-gray-800 dark:text-gray-100">T</p>
                                                    </div>
                                                </th>
                                                <th>
                                                    <div className="w-full flex justify-center">
                                                        <p className="text-2xl font-medium text-center text-gray-800 dark:text-gray-100">W</p>
                                                    </div>
                                                </th>
                                                <th>
                                                    <div className="w-full flex justify-center">
                                                ...
                                                <th>
                                                    <div className="w-full flex justify-center">
                                                        <p className="text-2xl font-medium text-center text-gray-800 dark:text-gray-100">F</p>
                                                    </div>
                                                </th>
                                                <th>
                                                    <div className="w-full flex justify-center">
                                                        <p className="text-2xl font-medium text-center text-gray-800 dark:text-gray-100">S</p>
                                                    </div>
                                                </th>
                                                <th>
                                                    <div className="w-full flex justify-center">
